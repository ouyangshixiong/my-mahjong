...
function recommendDiscard(payload, ruleset) {
  assertStrategyPayload(payload);
  if (ruleset === null || typeof ruleset !== "object" || ruleset.id !== payload.rulesetId) {
    throw new Error("ruleset must match payload.rulesetId");
  }
